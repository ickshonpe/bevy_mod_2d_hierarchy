...
use bevy::prelude::*;
use bevy_2d_transform_hierarchy::AltTransform2dPlugin;
...
fn spawn_2d_transform_hierarchy_desc(
    mut commands: Commands,
) {
    println!("with Transform2d + some desc");
    commands.despawn_all::<With<Transform2d>>();
    commands.despawn_all::<With<Transform>>();
    commands.despawn_all::<With<GlobalTransform2d>>();
    ...
    for n in 0..N {
        ...
        for n in 0..N / 2 {
            ...
            .insert(Transform2dPropagationDescriptor {
    ...
    if input.just_pressed(KeyCode::Space) {
        let next = 
            match state.current() {
                ...
                AppState::Transform2d => AppState::Transform2dDesc,
                AppState::Transform2dDesc => AppState::Transform2dGlobal,
...
pub fn main() {
    ...
    .add_plugin(AltTransform2dPlugin)
    ...
    .add_system_set(
        SystemSet::on_enter(AppState::Transform2dDesc)
        .with_system(spawn_2d_transform_hierarchy_desc)
    )
    .add_system_set(
